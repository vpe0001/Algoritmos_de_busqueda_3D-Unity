...
public abstract class ControladorCoche : MonoBehaviour {
	...
	public abstract Vector3[] CalcularRuta (Vector3 inicio, Vector3 meta, ObtenerMapa mapa, Parrilla parrilla);
	public abstract void iniciarPasoAestrella (Vector3 v_inicio, Vector3 v_meta, ObtenerMapa v_mapa, Parrilla v_parrilla);
